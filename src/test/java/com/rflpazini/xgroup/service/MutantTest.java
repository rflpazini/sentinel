...
public class MutantTest {
    ...
    public void checkConvertDnaListToArray() {
        ...
        Assert.assertThat(mutantService.convertDnaListToArray(mockList), Matchers.instanceOf(String[].class));
    }
    ...
    public void checkConvertDnaArrayTo2DArray() {
        ...
        Assert.assertThat(mutantService.convertDnaArrayTo2DArray(mock2DArray), Matchers.instanceOf(String[][].class));
    }
    ...
    public void checkIfDnaWasStoredOnDb() {
        ...
        Assert.assertThat(mutantService.checkIfDnaWasStoredOnDb(mockMutant), Matchers.instanceOf(Mutant.class));
    }
